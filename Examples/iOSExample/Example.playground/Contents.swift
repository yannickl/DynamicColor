...
ref.complemented()
ref.inverted()
ref.mixed(color: #colorLiteral(red: 0, green: 0, blue: 1, alpha: 1))
ref.mixed(color: #colorLiteral(red: 0, green: 1, blue: 0, alpha: 1))
ref.mixed(color: #colorLiteral(red: 1, green: 1, blue: 0, alpha: 1))
ref.tinted()
ref.shaded()
...
/*: ### Gradients */
[#colorLiteral(red: 0.2193539292, green: 0.4209204912, blue: 0.1073316187, alpha: 1), #colorLiteral(red: 0.9446166754, green: 0.6509571671, blue: 0.1558967829, alpha: 1)].colors(amount: 5)
